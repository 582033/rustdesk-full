...
const docTemplateadmin = `{
    ...
    "paths": {
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/admin.ExpireStats"
                                        }
                                    }
                                }
                            ]
        ...
        "/admin/user/list": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "过期状态：expired(已过期), expiring(即将过期), valid(有效), all(全部)",
                        "name": "expire_status",
                        "in": "query"
                    },
                    {
                        "type": "integer",
                        "description": "即将过期的天数阈值",
                        "name": "days",
                        "in": "query"
                    }
                ],
        ...
        "/admin/user/listWithExpireStatus": {
            "get": {
                "security": [
                    {
                        "token": []
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/admin.SetExpireTimeForm"
                        }
                    }
                ],
                "responses": {
