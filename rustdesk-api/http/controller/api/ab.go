...
import (
	...
	apiResponse "github.com/lejianwen/rustdesk-api/v2/http/response/api"
...
func (a *Ab) SharedProfiles(c *gin.Context) {
	...
	var res []*apiResponse.SharedProfilesPayload
	...
	for _, ab := range myAbCollectionList.AddressBookCollection {
		res = append(res, &apiResponse.SharedProfilesPayload{
